  ...
  >
    <view class="share-list">
      ...
      >
        <image
            :src="item.icon"
            style="width: 30rpx; height: 30rpx; margin-right: 18rpx"
            mode="widthFix"
        />
...
const lists = ref([
  {
    id: 'img',
    name: '以图片格式分享',
    icon: 'https://hnenjoy.oss-cn-shanghai.aliyuncs.com/scantool/static/assets/shareIcon/pic.png',
  },
  {
    id: 'longimg',
    name: '以长图格式分享',
    icon: 'https://hnenjoy.oss-cn-shanghai.aliyuncs.com/scantool/static/assets/shareIcon/longpic.png',
  },
  {
    id: 'pdf',
    name: '以PDF格式分享',
    icon: 'https://hnenjoy.oss-cn-shanghai.aliyuncs.com/scantool/static/assets/shareIcon/pdf.png',
  },
  {
    id: 'docx',
    name: '以Word格式分享',
    icon: 'https://hnenjoy.oss-cn-shanghai.aliyuncs.com/scantool/static/assets/shareIcon/doc.png',
    vip: true
  },
  {
    id: 'pptx',
    name: '以PPT格式分享',
    icon: 'https://hnenjoy.oss-cn-shanghai.aliyuncs.com/scantool/static/assets/shareIcon/ppt.png',
    vip: true
  ...
  },
  {
    id: 'xlsx',
    name: '以Excel格式分享',
    icon: 'https://hnenjoy.oss-cn-shanghai.aliyuncs.com/scantool/static/assets/shareIcon/excel.png',
    vip: true
  }
])
const user = ref({})
