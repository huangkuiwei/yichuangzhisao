<template>
  <view class="camera">
    <view>
      <camera
        ref="cameraRef"
        :style="{ height: `calc(100vh - ${cameraHeight}px )` }"
        binderror="error"
        bindscancode="takeCode"
      ></camera>
    </view>
    <view class="camera-fix">
      <view class="certificate" v-if="tab == 4">
        ...
        >
          <image :src="item.url" style="width: 32px; height: 21px" mode="" />
          <view style="margin-top: 3px">{{ item.name }}</view>
        </view>
      </view>
      <!-- <wd-gap height="10px"></wd-gap> -->
      <view style="height: 10px; background: #000000"></view>
      <wd-tabs
        :map-num="100"
        color="#fff"
      ...
      <view style="height: 5px; background: #000000"></view>
      <view class="camera-grid">
        <view class="camera-grid_li" @click="ustate = true">
          <image
            src="https://hnenjoy.oss-cn-shanghai.aliyuncs.com/scantool/static/assets/my/gongneng.png"
            style="width: 26px; height: 26px"
            mode=""
          />
          <view style="font-size: 0.85rem">更多工具</view>
        </view>
        ...
        <view class="camera-grid_li">
          ...
          <view @click="chooseLocalPicture" v-else>
            <wd-badge bg-color="#229CF7" :modelValue="picList.length">
              <view class="camera-pic_more">
                <image src="https://hnenjoy.oss-cn-shanghai.aliyuncs.com/scantool/static/assets/pic_img.png"/>
                <text>本地相册</text>
              </view>
            </wd-badge>
          </view>
  ...
  <wd-popup
    :modal="false"
    v-model="tState"
    custom-style="height: calc(100vh - 245px); background: #808080; top: 44px;"
    position="top"
  >
    <Tip></Tip>
  </wd-popup>
  ...
  <wd-popup
    ...
    :modal="false"
    v-model="tState"
    custom-style="height: calc(100vh - 201px); background: #808080; top: 0px;"
    position="top"
  >
    <Tip></Tip>
  </wd-popup>
  ...
  <wd-popup
    :modal="false"
    v-model="wState"
    custom-style="height: calc(100vh - 185px); background: #808080; top: 44px;"
    position="top"
  >
    <Alert></Alert>
  </wd-popup>
  ...
  <wd-popup
    :modal="false"
    v-model="wState"
    custom-style="height: calc(100vh - 141px); background: #808080; top: 0px;"
    position="top"
  >
    <Alert></Alert>
  </wd-popup>
  ...
  <wd-popup
    :modal="false"
    v-model="masterState"
    custom-style="height: calc(100vh - 245px); background: none; top: 44px;"
    position="top"
    :z-index="1"
  >
  ...
  <wd-popup
      ...
      custom-style="width: 468rpx; background: transparent; top: calc(50vh - 380rpx); margin: 0 auto;"
      position="top"
      :z-index="99999"
  >
    <view class="count-tip-container">
      <image src="https://hnenjoy.oss-cn-shanghai.aliyuncs.com/scantool/static/assets/vip-dialog-bg.png" mode="widthFix" />

      <view class="count-info">
        <view class="count-number">
          <text>您的免费体验</text>
          <text v-if="count === 0">已用尽</text>
          <text v-if="count === 1">仅剩{{ count }}次</text>
          <text v-if="count === 2">还剩{{ count }}次</text>
        </view>
        <view class="join">加入会员享受全部权益</view>
        <view class="btn" @click="toRouter('/pages/member/index')">立即开通</view>
        <view class="exit" @click="exit">狠心离开</view>
      </view>
    </view>
  </wd-popup>
</template>
...
const getCount = async () => {
  ...
  let res = await $http.get(`${url}/${action_name}`).catch(() => {})
...
const onTabs = (item) => {
  ...
  switch (item.index) {
    case 5:
      ...
      fileSrc.value =
        "https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/filetext.png";
      fileTip.value = '提取图片上的文字，可对识别的内容进行复制、编辑。'
      fileText.value = '开始提取'
      break;
    case 6:
      fileTipName.value = "证件扫描";
      fileSrc.value =
        "https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/wenjiansaomiao.png";
    ...
    case 7:
      ...
      fileSrc.value =
        "https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/paizhaojishu.png";
    ...
    case 8:
      ...
      fileSrc.value =
        "https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/shouxiewenzishibie.png";
    ...
    case 10:
      ...
      fileSrc.value =
        "https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/qushouxie.png";
...
const onCert = (item) => {
  ...
  switch (cerIndex.value) {
    case 1:
      imgSrc.value =
        "https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/oss6.png";
      break;
    case 2:
      imgSrc.value =
        "https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/yinhangka.png";
      break;
    case 3:
      imgSrc.value =
        "https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/hukou.png";
      break;
    case 4:
      imgSrc.value =
        "https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/huzhao.png";
      break;
    case 5:
      imgSrc.value =
        "https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/jiashizheng.png";
      break;
    case 6:
      imgSrc.value =
        "https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/biyezhengshu.png";
      break;
    case 7:
      imgSrc.value =
        "https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/zhizhao.png";
      break;
    default:
      break;
  }
