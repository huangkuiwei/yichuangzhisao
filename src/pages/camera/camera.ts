...
export const imgSrc = ref('https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/oss6.png')
export const wState = ref(false)
export const fileSrc = ref('https://yonganpicture.oss-cn-shenzhen.aliyuncs.com/icons/filetext.png')
